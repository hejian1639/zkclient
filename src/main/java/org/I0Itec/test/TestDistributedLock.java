...
public class TestDistributedLock {  
    ...
    public static void main(String[] args) {  
        ...
        final ZkClient zkClientExt1 = new ZkClient("192.168.1.107:2181", 5000, 5000, new BytesPushThroughSerializer());  
        final SimpleDistributedLockMutex mutex1 = new SimpleDistributedLockMutex(zkClientExt1, "/Mutex");  
          
        final ZkClient zkClientExt2 = new ZkClient("192.168.1.107:2181", 5000, 5000, new BytesPushThroughSerializer());  
